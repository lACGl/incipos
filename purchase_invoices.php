    ...
    <?php foreach ($invoices as $invoice): ?>
        <tr class="hover:bg-gray-50 <?php
            switch($invoice['durum']) {
                case 'bos':
                    echo 'bg-red-50 hover:bg-red-100';
                    break;
                case 'urun_girildi':
                    echo 'bg-yellow-50 hover:bg-yellow-100';
                    break;
                case 'kismi_aktarildi':
                    echo 'bg-blue-50 hover:bg-blue-100';
                    break;
                case 'aktarildi':
                    echo 'bg-green-50 hover:bg-green-100';
                    break;
                default:
                    echo 'bg-white';
            }
